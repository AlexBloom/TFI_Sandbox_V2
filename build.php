 <?php include_once 'inc/head.inc' ?>
		...
		<!--Web/SEO -->
				...
				<link rel="canonical" href="http://sandbox.tribecafilminstitute.org/build" />
				
		<!--Facebook -->
				<meta property="og:title" content="Build"/>
				<meta property="og:description" content="Tools, resources and advice to build your own interactive project." />
				<meta property="og:image" content="http://sandbox.tribecafilminstitute.org/img/content/sandbox.jpg"/>
				<meta property="og:url" content="http://sandbox.tribecafilminstitute.org/build"/>
		<!--Twitter -->
				<meta name="twitter:card" content="summary" />
				<meta name="twitter:site" content="@TribecaFilmIns">
				<meta name="twitter:title" content="Build"/>
				<meta name="twitter:description" content="Tools, resources and advice to build your own interactive project."/>
				<meta name="twitter:image" content="http://sandbox.tribecafilminstitute.org/img/content/sandbox.jpg"/>
				<meta name="twitter:url" content="http://sandbox.tribecafilminstitute.org/build" />
