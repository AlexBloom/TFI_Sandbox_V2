    ...
    var map;
	  ...
	  map.addMarker({ 
	  	...
	  	lng:-122.4376 , 
	  	infoWindow: {
	  		content:'A social impact lab connecting filmmakers, technologists and partner nonprofit organizations to create transmedia tools.'+
	  ...
	  map.addMarker({
	  		...
	  		lng:-73.9214216, 
	  		infoWindow:{
	  			content:'<p> Discovers both domestic and international indie films and new media projects and shares them with a diverse audience of film lovers and industry professionals.'+
			'<br><strong>Time of year:</strong> October'+ 
	  ...
	  map.addMarker({
	  		...
	  		lng:-115.175,  
	  		infoWindow:{
	  			content:'<p> One of the world’s largest annual hacker conventions.'+
	  ...
	  map.addMarker({ 
	  	...
	  	lng:-93.2614785,  
	  	infoWindow:{
	  		content:'<p> Assembling an incredible set of creative coders, data designers and artists.'+
	  	...
	  	lng:-73.7120832, 
	  	infoWindow:{
	  		content:'<p>Each year, the Festival seeks out new developments that move cinema forward, familiarizing audiences with 3D, VOD, a whole spectrum of different formats and thelatst creative findings.'+ 
	  		'<br> <strong>Time of year:</strong> October '+
	  ...
	  map.addMarker(	{ 
	  	...
	  	lng:-80.2310801, 
	  	infoWindow:{
	  		content:'<p> Bringing together cross-media’s leading international creators, thinkers and practitioners.'+
	  	...
	  	lng:-79.3777061,  
	  	infoWindow:{
	  		content:'<p> North America’s largest documentary festival, conference and market. '+
	  	...
	  	lng:-73.9780035, 
	  	infoWindow:{
	  		content:'<p>Hosted by IFP, Independent Film Week showcases independent films and guides filmmakers in the art, technology and business of independent filmmaking.'+ 
	  	...
	  	lng:-93.2614785, 
	  	infoWindow:{
	  		content:'<p>This event brings together an international roster of acclaimed creators to explore the intersection of art, technology and interaction.'+ 
	  		'<br> <strong>Time of year:</strong> September'+ 
	  		'<br> <strong>Location:</strong> Minneapolis, Minnesota'+
	  	...
	  	lng:-115.175,  
	  	infoWindow:{
	  		content:'<p> Mirage International Film Festival\u0027s New Media Marvels competitive program is designed to bring attention to the emerging world of new media.'+ 
	  		'<br> <strong>Time of year:</strong> August '+
	  	...
	  	lng:-75.1180329, 
	  	infoWindow:{
	  		content:'<p>A conference that brings together creators, thinkers, policy makers, administrators and funders to learn about the field’s future opportunities, to create a national latorm for the media arts and to strengthen networks.'+ 
	  		'<br> <strong>Time of year:</strong> August '+
	  	...
	  	lng:-97.7534014, 
	  	infoWindow:{
	  		content:'<p>A three-day festival of creative music, performance art, film, and installations.'+
	  		'<br> <strong>Time of year:</strong> June '+
	  	...
	  	lng:-73.7120832, 
	  	infoWindow:{
	  		content:'<p>Presents a selection of the year’s best documentaries from Canada and around the world for general and professional audiences.'+ 
	  	...
	  	lng:-111.4999615, 
	  	infoWindow:{
	  		content:'<p>Lab for artists working at the convergence of film, art, and new media technologies.'+
	  		'<br><strong>Time of year:</strong> October'+
	  	...
	  	lng:-97.7534014,
	  	infoWindow:{
	  		content:'<p> Film and Interactive panels to inspire digital thinking.'+
	  	...
	  	lng:-73.9780035, 
	  	infoWindow:{
	  		content:'<p>Offering a transmedia section : Storyscapes.'+
	  	...
	  	lng:-92.234803,
	  	infoWindow:{
	  		content:'<p>Exhibits the best new nonfiction filmmaking. They strive to present a program that challenges viewers to think critically about both the content of the films and their own assumptions.'+ 
	  		'<br> <strong> Time of year:</strong> March'+ 
	  	...
	  	lng:-72.5521905, 
	  	infoWindow:{
	  		content:'<p> An Innovative Exploration of Digital Media in the Public Interest.'+
	  		'<br> <strong>Time of year:</strong> November'+
		...
		map.addMarker(
	  	...
	  	lng:-63.28125, 
	  	infoWindow:{
	  		content:'<p> Annual week long, 24-hours-a-day technology festival where thousands of “campuseros” (hackers, developers, gamers and geeks) equipped with laptops camp on-site and immerse themselves in a truly unique environment.'+				
	  	...
	  	lng:-56.2303067, 
	  	infoWindow:{
	  		content:'<p>A workshop that leads to the production of interactive non-fiction prototypes geared to work in progress on documentary films or series, or projects exclusively made for web.'+
	  	...
	  	lng:-46.5952992, 
	  	infoWindow:{
	  		content:'<p>Festival serves as a lead indicator of the plurality of the work created in the interactive art field not only nationally but also internationally.'+
	  	...
	  	lng:-75.49767, 
	  	infoWindow:{
	  		content:'<p>A space for meeting and discussion on topics rlatd to visual design, electronic arts, digital audiovisual creation, digital sound, and electro-acoustic.'+
	  		'<br><strong>Time of year:</strong> April'+
	  ...
	  map.addMarker({
		title:'Convergence', 
	  	...
	  	lng:-0.1015987, 
	  	infoWindow:{
	  		content:'<p>A festival that takes place throughout East London that focuses on pioneers who use technology to innovate.'+ 
	  		'<br> <strong> Time of year:</strong> April'+ 
	  	...
	  	lng:12.5608388, 
	  	infoWindow:{
	  		content:'<p>A forum, a conference and a lab working to develop new and sustainable ways of thinking within media.'+
	  		'<br> <strong>Time of year:</strong> November'+
	  	...
	  	lng:2.3470599, 
	  	infoWindow:{
	  		content:'<p> A european crossmedia content market'+
	  		'<br><strong>Time of year:</strong> June'+
	  	...
	  	map.addMarker({ 
	  	title:'DEAF: Dutch Electronic Art Festival ', 
	  	lat:51.9279723,
	  	lng:4.4904063, 
	  	infoWindow:{
	  		content:'<p>Festival with a thematic approach. Its aim is to harbour new and speclatve views about current developments and themes in our technological culture and society.'+
	  	...
	  	lng:12.3936349, 
	  	infoWindow:{
	  		content:'<p> An inspirational conference lab on the current trends of new media providing access to new information, intense networking and individual support.'+
	  		'<br> <strong>Time of year:</strong> November'+
	  	...
	  	lng:14.4656239, 
	  	infoWindow:{
	  		content:'<p> A free festival of New Media, Music and Art.'+
	  	...
	  	lng:-1.5557543 , 
	  	infoWindow:{
	  		content:'<p> The only international festival that showcases all creative genres: drama, series, documentary, reportage, performing arts and the Smart FIP@.'+ 
	  	...
	  	lng:6.1440885, 
	  	infoWindow:{
	  		content:'<p>Explores the rlatonship between cinema, television and new forms of digital creation.'+
	  		'<br> <strong> Time of year:</strong> November'+ 
	  	...
	  	lng:-2.5907094, 
	  	infoWindow:{
	  		content:'<p>Symposium and website dedicated to interactive documentary'+
	  		'<br>	<strong>Time of year:</strong> March'+
	  	...
	  	lng:4.8986166, 
	  	infoWindow:{
	  		content:'<p>Showcasing new and unexpected forms of digital documentary storytelling.'+
	  		'<br> <strong>Time of year:</strong> November'+
	  	...
	  	lng:2.1487679, 
	  	infoWindow:{
	  		content:'<p>The InterDocsBarcelona is a professional meeting to disseminate, create and finance the interactive documentary.'+ 
	  		'<br> <strong> Time of year:</strong> May'+  
	  	...
	  	lng:1.8063239, 
	  	infoWindow:{
	  		content:'<p>Exhibits an exclusive selection of documentary projects and ready made programmes, aiming to enhance the professional and creative exchange between the 12 MEDA countries and the 28 EU countries.'+ 
	  		'<br> <strong> Time of year:</strong> October'+ 
	  	...
	  	lng:-0.1015987, 
	  	infoWindow:{
	  		content:'<p> A festival dedicated to finding, energizing and creating a community of people working with technology to build participation, understanding and control into Internet life.'+
	  		'<br> <strong> Time of year:</strong> October'+ 
	  		'<br> <strong> Location:</strong> London, United Kingdom'+ 
	  	...
	  	lng:-0.1015987,  
	  	infoWindow:{
	  		content:'<p>Conference, pitching forum and market for interactive projects'+
	  		'<br>	<strong>Time of year:</strong> October'+
	  	...
	  	lng:20.4203223, 
	  	infoWindow:{
	  		content:'<p>Resonate is a latorm for networking, knowledge sharing and education. It brings together artists, designers and educators to participate in a forward-looking debate on the position of technology in art and culture.'+
	  		'<br> <strong> Time of Year:</strong> April '+ 
	  	...
	  	lng:-1.4994561, 
	  	infoWindow:{
	  		content:'<p>Interactive panels (including a full-day dedicated to interactive) and a Cross-media section for projects'+
	  		'<br> <strong>Time of year:</strong> June'+
	  	...
	  	lng:2.1487679,
	  	infoWindow:{
	  		content:'<p>Sónar+D selects the most outstanding projects by creative laboratories, universities and companies to showcase new forms of creation, production and marketing. Sounds in 3D, interaction repertoires and robotic experiments.'+
	  		'<br> <strong> Time of year:</strong> June'+
	  		'<br> <strong> Location:</strong> Barcelona, Spain'+
	  	...
	  	lng:-1.176261, 
	  	infoWindow:{
	  		content:'<p>Sunny Side hosts international television markets focusing on specialist factual and documentary programming, to promote co-production and sales rlatonships between production companies and broadcasters.'+
	  		'<br> <strong> Time of year:</strong> June'+ 
	  	...
	  	lng:13.4261419,
	  	infoWindow:{
	  		content:'<p>A festival and year-round project that draws out new connections between art, culture and technology.'+
	  		'<br> <strong>Time of year:</strong> February'+
	  	...
	  	lng:4.8986166,
	  	infoWindow:{
	  		content:'<p> Forum to pitch cross-media projects.'+
	  		'<br>	<strong>Time of year:</strong> November'+
	  		'<br>	<strong>Location:</strong> Amsterdam, Netherlands'+
	  	...
	  	lng:-1.4994561,
	  	infoWindow:{
	  		content:'<p>Helping people understand interactive storytelling and cross-latorm development through labs'+
	  		'<br><strong>Location:</strong> Sheffield, UK'+
	  	...
	  	lng:139.710388 , 
	  	infoWindow:{
	  		content:'<p>Honoring outstanding works from a diverse range of media- from animation and comics to media art and games'+
	  		'<br> <strong>Time of year:</strong> February'+
	  	...
	  	lng:114.1535941, 
	  	infoWindow:{
	  		content:'<p>Festival brings cutting-edge works to provoke the thought in the technological hub that Hong Kong is'+
	  		'<br> <strong>Time of year:</strong> November'+
	  ...
	  map.addMarker({ 
	  	...
	  	lng:126.98955, 
	  	infoWindow:{
	  		content:'<p>Korea’s first and leading art festival of alternative videos, display diverse ways that new forms of media can be used and sustained in modern society.'+
	  		'<br><strong>Time of year:</strong> October'+
	  ...
	  map.addMarker({
		title:'Antenna', 
	  	...
	  	lng:150.9224326, 
	  	infoWindow:{
	  		content:'<p>International film festival that screens feature length documentaries.'+
	  		'<br> <strong> Time of year:</strong> October '+
	  ...
	  map.addMarker({
		title:' Documentary Edge Festival', 
	  	...
	  	lng:174.8654693, 
	  	infoWindow:{
	  		content:'<p>New Zealand’s only international documentary film festival held annually.'+ 
	  ...
	  map.addMarker({ 
	  	...
	  	lng:30.9924624, 
	  	infoWindow:{
	  		content:'<p>The festival also offers filmmaker workshops, industry seminars, discussion forums, and outreach activities'+
	  		'<br> <strong>Time of year:</strong> July'+
