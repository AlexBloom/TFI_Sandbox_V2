<?php include_once 'inc/head.inc' ?>
		...
		<!--Web/SEO -->
		        <title>Funding | TFI Sandbox</title>
...
<section id="main" class="clearfix">
	<article class="clearfix">
		...
		<section class="content anchor" id="HowToRaiseFunds">
			...
			<ul>	
				<li>	<p><strong>Read the instructions. </strong> ALL OF THEM. Probably twice.  It is very easy to skip taking a deep dive into the specifics of an RFP and get right to typing into the text box on the application page, but this can set you back hours in the process. Institutional funders often use the same form for different applications, so you may encounter a directive like:  “Leave sections A through C blank. Fill in Section D with one sentence that describes your project.” If your proposal comes along with part of the application filled in that didn't need to be, it most likely goes into the trash. If you can’t follow simple administrative instructions, I’m scared to write you a check. 
				</p></li>
				...
				<li>	<p><strong>Proofread! </strong> When you’ve spent hours upon hours reviewing project proposals, poor grammar and careless spelling can feel like a personal affront to your sanity. Your proposal deserves the same polish as your project. If an applicant hasn't taken the time to distinguish the difference between your and you're, funders may become suspucuous of their abiity to carry out a complex project. 
				</p></li>
			</ul>
