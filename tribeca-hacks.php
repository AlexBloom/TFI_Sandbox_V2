...
<section id="main" class="clearfix">
	...
	<div class="right-column clearfix">
			<section class="content anchor" id="HackathonMentality">
				...
				<p>(or how collaboration and prototyping can improve the interactive storytelling ecosystem)</p>  
				...
				<h3>Interactivity is an investment</h3>
				...
				<p>The question then is: how do you optimize these investments and how do you get the best return on them? Surely the answer has to be different depending on the organization considered. However media, independent creators, producers have in common certain practices generating a waste of resources, such as:</p>
				...
				<ul>
					...
					<li>	the absence of prototyping providing user feedback in the development phase, 
					</li>
				...
				<h3>Ideas are meant to be hacked</h3>

				<p>Interactive production is perceived as many as an experiment but too few really adopt an experimenting stance. More often than not, producers settle on applying a process derived from television or cinema production. For us creative technologists, it often means that people come to us when funding as been secure, with unclear specifications, to ask us to « do it. And if you have some good ideas on how to improve the whole thing, feel free… ». <strong>This only has the allure of collaboration but it is simply a more dilettante form of subcontracting.</strong></p>
				...
				<p>Basically, I find that the best time to do that « story hacking » is pretty soon after the concept emerged, before the author or producer develops it to much in a single direction and gets too emotionally attached to it. The point is, the more you work on your own, on your very first idea, the more difficult it will be to welcome new ideas or even a complete creative destruction process. </p>

				<p>Because if you build a team, they will be eager to provide new ideas, to strengthen your project with their unique and valuable point of view and skill set. <strong>If you are not open to that collaboration, you don’t need a team you need a workforce.</strong></p> 

				<p>We’ve experimented a lot on how, when, where is it best to set up those story hackathons. Each time we made arrangement to our method, trying to refine it into a series of guidelines we feel confident in sharing as good practices that can serve all of you interactive storytellers, wherever you are and whatever your project. Here are a few of those.</p>

				<p><strong>Do not wait.</strong> As I said, timing is key. A mere concept will soon become someone's « baby » you won’t be able to change without a great expense of time, negotiation and emotions. Assemble a team quickly to workshop all the possible developments of that original idea before you get stuck in a one-way street. </p>
				...
				<p>Now that you’ve had all those brilliant ideas, that you’ve made the conscious effort to determine what is the core of your experience, you can go forward and make stuff. Too often, interactive projects try to seek funding and partnerships with a video trailer and carefully chosen words. This is important for sure, but how much energy is wasted explaining with words, pitches, meetings what makes the strength of the project: the user experience.</p>
				...
				<p>It also means no user feedback was collected and acted upon during production development. <strong>I never heard of a software company releasing a product without user testing and multiple alpha and beta versions. Why would interactive experiences be any different?</strong></p>
