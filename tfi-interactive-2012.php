<?php include_once 'inc/head.inc' ?>
		...
		<!--Web/SEO -->
		        <title>TFI Interactive 2012 | TFI Sandbox</title>
				...
				<link rel="canonical" href="http://sandbox.tribecafilminstitute.org/tfi-interactive-2012" />
		...
		<!--Facebook -->
				...
				<meta property="og:url" content="http://sandbox.tribecafilminstitute.org/tfi-interactive-2012"/>
		<!--Twitter -->
				...
				<meta name="twitter:url" content="http://sandbox.tribecafilminstitute.org/tfi-interactive-2012" />
	...
	<ul>
		...
		<li>
			<dl class="tertiary">
				...
				<dt> 2012 <span class="icon-down"> <span> </dt>
