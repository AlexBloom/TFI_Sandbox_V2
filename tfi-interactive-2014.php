		...
		<section class="content">
			...
			<h3>Lineup </h3>
					...
					<p> <strong> <a href="https://www.youtube.com/watch?v=zob0aEXXnDI"target=_blank>OPENING KEYNOTE: THE AUDIENCE HAS AN AUDIENCE</a></strong> </p> 
						<ul>
							<li> Kenyatta Cheese, Professional Internet Enthusiast</li></ul>
					
					<p> <strong> <a href="https://www.youtube.com/watch?v=8HZ8nmgsVnc"target=_blank>OBJECT NARRATIVES</a></strong> </p> 
						<ul>
							<li> Alexis Lloyd, Creative Director, The New York Times R&amp;D Lab</li></ul>
					
					<p> <strong> PHYSICAL COMPUTING AND HUMAN INTERACTION</strong> </p> 
						<ul>
							<li> Tom Igoe, Associate Arts Professor, ITP/Tisch School of the Arts/NYU; Co-Founder, Arduino</li></ul>
					...
					<p> <strong> LYKA: THE ADVENTURE</strong> </p> 
						<ul>
							<li> Lance Weiler, Story Architect; Founding Member, Digital Storytelling Lab at Columbia University</li></ul>
			...
			<ul class="no-style">
				...
				<li> <strong> A°,</strong> by Rain Ashford, Avaylo Getov, Kyle Gustafson, Jasmine Idun Lyman, Julian Maciejewski and Jason Wishnow
				</li>
				<li> <strong> Climate Anxiety,</strong> by Clay Ewing, Ana Carolina von Hertwig, Erin Lamb, Oliver Keller, Charles Ayats and Alex Herrmann
				</li>
				<li> <strong> Dancing Robot,</strong> by Graeme Peter
				</li>
				<li> <strong> Emergence,</strong> by Nadja Oertelt, Julia Stein a.k.a. JULIACKS, Adria Le Boeuf, Laura Bortoloni, Mike Robbins and Joao Antunes Pequenao
				</li>
				<li> <strong> Emotional Arcade,</strong> by Brent Hoff
				</li>
				<li> <strong> Flappy Box,</strong> by Fawn Qiu
				</li>
				<li> <strong> Flow,</strong> by Jim Hwang, Woonyung Choi, Inpyo Chang and John N Choi
				</li>
				<li> <strong> Immigrant Nation,</strong> by Theo Rigby and Kate Mclean
				</li>
				<li> <strong> Little Drummer Bot,</strong> by Maja Simone Cerar
				</li>
				<li> <strong> Lyka’s Adventure,</strong> by Lance Weiler, Atley Loughridge and Janine Saunders
				</li>
				<li> <strong> Beta, by Errol King,</strong> Chris Moody and Hidden Level Games, LLC
				</li>
				<li> <strong> Nanny Van,</strong> by Marisa Jahn, Studio REV and The National 
				</li>
